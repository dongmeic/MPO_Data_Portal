...
# 	                                           
	...
	#Go through each station for each site and determine data completeness and quality
	#################################
	#Initialize a data frame to store all downloaded and formatted climate data
